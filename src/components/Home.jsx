  ...
  useEffect(() => {
    async function fetchData() {
      const request = await axios.get(
        'https://api.themoviedb.org/3/movie/now_playing?api_key=6599bc26f4ca86fd26961ad8384590da&language=en-US&page=1&region=us'
      )
    ...
    <>
      <div className='content'>
        <div className='content-left'>
          ...
          <p>
            Instantly find where to stream movies and shows. See what’s trending{' '}
            <br /> and discover something new.
          </p>

...
function Modal({ open, onClose, setProviders, providers }) {
  ...
  const keys = useState([8, 337, 9, 384, 15, 531])
        ...
        <div className='services'>
          ...
          >
            <div className='left-item'>
              <img
                src={img_URL + '/9A1JSVmSxsyaBK4SUFsYVqbAYfW.jpg'}
                alt='netflix'
              />
              <h3>Netflix</h3>
            </div>
          ...
          >
            <div className='left-item'>
              <img
                src={img_URL + '/dgPueyEdOwpQ10fjuhL2WYFQwQs.jpg'}
                alt='disney'
              />
              <h3>Disney+</h3>
            </div>
          ...
          >
            <div className='left-item'>
              <img
                src={img_URL + '/68MNrwlkpF7WnmNPXLah69CR5cb.jpg'}
                alt='amazon'
              />
          ...
          >
            <div className='left-item'>
              <img
                src={img_URL + '/aS2zvJWn9mwiCOeaaCkIh4wleZS.jpg'}
                alt='hbo'
              />
              <h3>HBO Max</h3>
            </div>
          ...
          >
            <div className='left-item'>
              <img
                src={img_URL + '/giwM8XX4V2AQb9vsoN7yti82tKK.jpg'}
                alt='hulu'
              />
              <h3>Hulu</h3>
            </div>
          ...
          >
            <div className='left-item'>
              <img
                src={img_URL + '/pkAHkRhIq3Iu0ZlEhDzbguSlyZF.jpg'}
                alt='paramount'
              />
              <h3>Paramount+</h3>
            </div>
